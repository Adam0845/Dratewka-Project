...
const Crafts = [
    ...
    // new Craft("16", "43", "17(L)", "You made a nice sheeptrunk, OK"),
    // new Craft("18", "36", "19", "The butcher gave you wool"),
    // new Craft("19", "43", "20(L)", "You prepared skin for your fake sheep, OK"),
    // new Craft("21", "57", "22", "You used your tools to make a rag"),
    // new Craft("22", "43", "23(L)", "You made a fake sheephead, OK"),
    // new Craft("24", "11", "25", "You are digging... (timeout) and digging... (timeout) That's enough sulphur for you"),
    // new Craft("25", "43", "26(L)", "You prepared a solid poison, OK"),
    // new Craft("27", "21", "28", "You got a bucket full of tar"),
    // new Craft("28", "43", "29(L)", "You prepared a liquid poison, OK"),
    // new Craft("37", "43", "37", "Your fake sheep is full of poison and ready to be eaten by the dragon"),
    // new Craft("37", "43", "30(L)", "The dragon noticed your gift... (timeout) The dragon ate your sheep and died! - podmiana grafiki na lokacji (martwy smok)!"),
